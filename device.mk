...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_hd1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_hd1.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_hd1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_hd1.xml \
...
PRODUCT_PACKAGES += \
    ...
    init.fingerprint.microarray.rc \
    init.hd1.fqc.rc \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/bdwlan_HD1_cal.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_HD1_cal.bin \
...
# Inherit vendor
$(call inherit-product, vendor/sharp/HD1/HD1-vendor.mk)